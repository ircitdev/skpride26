/**
 * 🌓 ПЕРЕКЛЮЧАТЕЛЬ ТЕМ ДЛЯ МОДАЛЬНОГО ОКНА "О НАС"
 * СК ПРАЙД
 */
...
(function() {
  ...
  console.log('📦 about-theme.js загружен');

  // Ключ для localStorage
  const THEME_KEY = 'aboutModalTheme';
  ...
  function init() {
    ...
    const toggleButton = document.getElementById('aboutThemeToggle');
    if (toggleButton) {
